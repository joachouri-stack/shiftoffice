/** Questions fréquentes de la landing — module pur (réutilisé pour le JSON-LD). */
export const FAQ = [
  {
  ...
  {
    q: "Quels documents sont vraiment gratuits ?",
    a: "Quatre documents sont totalement gratuits et sans limite : le certificat de travail, l'attestation employeur, la note de frais et la quittance de loyer. Aucun compte requis — remplissez le formulaire, téléchargez le PDF.",
  },
  {
    q: "Dois-je créer un compte pour générer un document ?",
    a: "Non, aucun compte n'est requis — ni pour les documents gratuits, ni pour les payants. Le compte est optionnel : il sert à synchroniser vos entreprises, salariés et documents sur tous vos appareils.",
  },
  {
